    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn(
            "justify-between bg-transparent text-white border border-grayBorders hover:bg-transparent hover:border-grayBorders focus:ring-0 focus:ring-offset-0 h-[46px] px-3",
            className
          )}
        >
          {selectedCountry ? (
      ...
      <PopoverContent className="w-[280px] p-0 bg-black border-grayBorders">
        <Command className="bg-black">
          <CommandInput
            placeholder="Search country..."
            className="h-9 bg-transparent text-white placeholder:text-gray-500 border-none"
          />
