...
export const TypingIndicator = ({ typingUsers, participants }: TypingIndicatorProps) => {
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="w-8 h-8">
        <Avatar className="w-8 h-8">
          <AvatarImage 
            src={typeof (typingParticipants[0].user as User).profilePicture === 'object' 
              ? (typingParticipants[0].user as User).profilePicture?.url 
              : undefined}
