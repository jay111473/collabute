      ...
      <div className="w-full max-w-6xl space-y-8">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <p className="text-slate-600 max-w-xl">
            Select the programming languages you&apos;re most comfortable with.
            We&apos;ll use this information to match you with relevant projects.
          </p>
        </div>
  ...
  return (
    <Suspense fallback={
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary2"></div>
      </div>
    }>
      <ChallengeContent />
    </Suspense>
